<?php
    ...
    if(isset($_POST["envio"])){
        if(empty($_POST["titulo"]) || empty($_POST["descripcion"])){
            ...
            $consulta = $dbh->prepare("INSERT INTO productos (id, nombreProducto, descripcion, precio) VALUES (NULL, ?, ?, ?)");
            $consulta->execute([$_SESSION["nombreProducto"], $_POST["descripcion"], $_POST["descripcion"]]);
                ...
                <input type="file" class="form-control-file" id="exampleFormControlFile1">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="form-group blue-border-focus">
                        <label for="exampleFormControlTextarea5">Precio</label>
